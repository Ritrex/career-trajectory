...
router.post(
  ...
  (req, res) => {
    console.log("Did you get what I sent you?:",req.files['ticket_partial'],req.files['ticket_detail']);
    ...
    let sale={item,event_arena, min_price, max_price,name,userid:req.user._id}
    Sale.create(sale)
    .then(succ=>{
